...
//  OpenGLES7
//
//  Created by arplanet on 2018/8/23.
...
@implementation AmbientCube

- (instancetype)initWithShader:(AmbientSimpleEffect *)shader {
    if ( self = [super initWithName:"Cube" shader:shader verteices:(AmbientVertex *)verteices vertexCount:sizeof(verteices)/sizeof(verteices[0]) indeices:(GLubyte *)indeices index:sizeof(indeices)/sizeof(indeices[0])]) {
